...
namespace Spatial
{
    ...
    //--
    Octree::Octree(const Vector& refCenter, float f32HalfWidth, int i32Rebuild) :
        ISpatialStructure(),
    ...
    //--
    OctreeNode::OctreeNode(OctreeNode* pParent, const Vector& refCenter, float f32HalfWidth, int i32Depth) :
    ...
    OctreeNode::AddObjects(ISpatialObject* pObjectList, int i32ObjectCount)
    {
        ...
        while(pIter)
        {
            ...
            Vector vec3Center = pIter->VGetPosition();
